...
//                        <a>Puntuación: " + data.tiendas[i].puntuacion + "</a><br></div>"
                ...
                /*$('#div').append(
                 ...
                 "<a>Puntuación: " + data.tiendas[i].puntuacion + "</a><br>"*/
                            ...
                            "<a href ='seleccionProducto.jsp'><div class='col-md-4' id='item' style='cursor:pointer' onclick='sendName(" + data.tiendas[i].id + ")'><img id='perfil' src=Pictures/" + data.tiendas[i].idfondo + "><p id='titulo_uno'>" + data.tiendas[i].nombre + "</p><p id='descripcion'>Vendedor: " + data.tiendas[i].vendedor + "</p><p id='descripcion2'>Puntuación: " + data.tiendas[i].puntuacion + "</p></div></a>",
                            );
            }
        },
        error: function () {
